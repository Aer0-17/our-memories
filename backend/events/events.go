...
const (
	...
	CoupleQuestionCreated  Type = "couple_question.created"
	CoupleQuestionAnswered Type = "couple_question.answered"
	CoupleQuestionRevealed Type = "couple_question.revealed"
	CoupleQuestionDeleted  Type = "couple_question.deleted"
)
